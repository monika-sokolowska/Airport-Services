...
const BoardingArrivalForm = ({ flight }) => {
  ...
  useEffect(() => {
    ...
    if (availableEmployees) {
      const serviceEmployees = availableEmployees.filter(
        (availableEmployee) => availableEmployee.service === "Boarding Service"
      );
  ...
  return (
    <form className="service-form" onSubmit={onSubmit}>
      <label className="service-title">Boarding Arrival service</label>
      <div>
